...
/*		BinarySearchTree binarySearchTree = new BinarySearchTree();
		...
		binarySearchTree2.insertNodeRecursive(20);
		binarySearchTree2.insertNodeRecursive(44);
		...
		TreeNode root = binarySearchTree2.getRoot();
		binarySearchTree2.printInOrder(root);
		System.out.println();
		//binarySearchTree2.deleteNode(binarySearchTree2, 50);
		//binarySearchTree2.deleteNode(binarySearchTree2, 62);
		binarySearchTree2.printCompleteTree(root);
		System.out.println();
		//binarySearchTree2.printLevel(binarySearchTree2.getRoot(), 3);
		//binarySearchTree2.printSpiralBinaryTree(root);
		System.out.println();
		//binarySearchTree2.printCompleteBinaryTreeUsingStacks(root);
		System.out.println(binarySearchTree2.KthSmallestElement(root, 4));
		System.out.println(binarySearchTree2.KthLargestElement(root, 15));
